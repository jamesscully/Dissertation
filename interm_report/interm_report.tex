...
\subsection{Face}
For the Face, we opted to use an enumerated as these are generic datatypes that are both easy to read in code (they do not need to be initialized each time) and can be assigned values similar to normal classes. 
