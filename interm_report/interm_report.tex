...
The most critical part and the binding element of this project is the actual mobile application itself. One of the criticisms with poker apps and the aforementioned 'bothering' of the user with offers, is that the design is not simple and intuitive. We've opted to use basic Android activities and layouts instead of a mobile game engine, such as the likes of Unreal's mobile components or Unity. This is because often these engines, while they are powerful, have a steep learning curve to master and implement; they also do not always have the best backwards compatibility with older devices. As our Android target is KitKat (Vers. 4.4), most components of our interface will work on these devices. 
